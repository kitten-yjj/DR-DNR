...
from DNR.temporaryFiles import readLoad
...
file_path = fileURL + "IEEE118-1.csv"
L, data_node, node_con, r_ij, x_ij = readFile.read_File(file_path, 118)
...
for i in range(1, N-1):
    P_load[i] = data_node[i - 1][5] / 1000 / baseMVA
    Q_load[i] = data_node[i - 1][6] / 1000 / baseMVA
for i in range(L):
...
#     # plt.savefig(f"/Users/yinjinjiao/Documents/project/DNR/picture/IEEE118/{t1}.svg", format='svg')
#
#     # 显示图形
#     # plt.show()
#
